...
* **Contact:** +91 9991674770 | vaibhavjangid96@gmail.com | Bawal, Rewari, Haryana (123501)
* **LinkedIn:** [linkedin.com/in/vaibhav-jangid](https://linkedin.com) (Placeholder)

---

## TECHNICAL SKILLS
- **Frontend Technologies:** HTML5, CSS3, JavaScript (ES6+), TypeScript, Angular 8+, React, Responsive Web Design.
- **Backend & APIs:** Java (Spring Boot, Spring Security), Python (FastAPI, Django, Flask), Node.js, Microservices, RESTful APIs, Apache Kafka, gRPC.
- **Databases & Caching:** PostgreSQL, MySQL, MongoDB, Redis.
- **Cloud & DevOps:** AWS (EC2, S3, RDS), Docker, Kubernetes, CI/CD, Git (GitFlow), Linux.
- **Security & Testing:** OAuth2, JWT, Snyk, Web Testing, Jest, PyTest, JUnit.
...
*Node.js, Express.js, Apache Kafka, Microservices, REST APIs, WebSocket*
* Built an interactive algorithmic trading system with Node.js & CoinSwitch REST APIs, executing live/paper trades across technical strategies (RSI, MACD, MA).
* Architected Kafka event-driven microservices for real-time market data ingestion, order routing, and live position monitoring.
...
* **B.Sc. in Data Science** | IIT Madras | *2023 – 2026*
  * Core focus on Python programming, database management, systems analysis, and data structures.
